...
public class CharaController {
	...
	charaData.setProperty(PROFICIENCY_LANGUAGE, chara.getProficiency_language());
	...
	charaData.setProperty(IDEALS, chara.getIdeals());
	charaData.setProperty(BONDS, chara.getBonds());
	charaData.setProperty(FLAWS, chara.getFlaws());
	charaData.setProperty(FEATURES_TRAITS, chara.getFeatures_traits());
    ...
    public String save(
	    Model model, 
	    @ModelAttribute PlayerChara chara)
    {
	Entity charaData;
